 ...
 * on 2016-11-06 at 17:09:12 UTC 
 * Modify at your own risk.
 */

package com.example.prerak.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://fourth-arena-438.appspot.com/_ah/api/";
  ...
  public class GetJokes extends MyApiRequest<com.example.prerak.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected GetJokes() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.prerak.myapplication.backend.myApi.model.MyBean.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.prerak.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.prerak.myapplication.backend.myApi.model.MyBean.class);
